...
public class KahveMakinasi {
  ...
  3.Espresso
        ...
        String hangiKahve oluşturun ve var olan kahvelerden birini yazınız. (örn: Türk Kahvesi,  ya da türk kahvesi.
  ...
  String boyut oluşturun...
       ...
       Projeyi bilerek biraz zor hazırladım. Üzerinde fazla fazla kafa yormanız ve "grupça çalışmanız için" böyle düzenledim. Yapamayan arkadaşlar kesinlikle canlarını sıkmasın.
       ...
       Sizlere daha sonra çözümlerini atacağım. Ödev ile alakalı sorularınızı grup arkadaşlarınıza yöneltin.
